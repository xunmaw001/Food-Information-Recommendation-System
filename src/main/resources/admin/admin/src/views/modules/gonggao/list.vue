        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '饮食资讯' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.gonggaoName" placeholder="饮食资讯" clearable></el-input>
                     </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '资讯类型' : ''">
                        <el-select v-model="searchForm.gonggaoTypes" placeholder="请选择资讯类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/meishixinxituijianxitong/upload/gonggaoMuBan.xls"
                        >批量导入饮食资讯数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gonggao','导入导出')"
