<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="口味编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="口味编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="口味编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="口味编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="口味" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="口味" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="口味" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    this.$http({
                        ...
                        method: "post",
                        data: {"dicCode":"caipu_kouwei_types"}
                    }).then(({ data }) => {
                        if (data && data.code === 0) {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('口味不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="caipu_kouwei_types";
                        ruleForm["dicName"]="口味";
                        this.$http({
